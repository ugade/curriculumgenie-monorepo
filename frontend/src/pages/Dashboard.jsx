...
export default function Dashboard() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.log('[CurriculumGenie] Raw API Response:', response);
      ...
      setError('Failed to generate document. Please check your connection or backend.');
    } finally {
      setLoading(false);
    }
  };
